...
import static edu.aku.dmu.polio_karachi_ighd.database.DatabaseHelper.DATABASE_PASSWORD;
...
import edu.aku.dmu.polio_karachi_ighd.models.RandomHH;
import edu.aku.dmu.polio_karachi_ighd.models.Users;
import edu.aku.dmu.polio_karachi_ighd.ui.LockActivity;
...
public class MainApp extends Application {
    ...
    public static final String _HOST_URL = MainApp._IP + "/polio_ighd/api/";// .TEST server;
    ...
    public static final String _UPDATE_URL = MainApp._IP + "/polio_ighd/app/survey";
    ...
    public static int versionCode = edu.aku.dmu.polio_karachi_ighd.BuildConfig.VERSION_CODE;
    public static String versionName = edu.aku.dmu.polio_karachi_ighd.BuildConfig.VERSION_NAME;
