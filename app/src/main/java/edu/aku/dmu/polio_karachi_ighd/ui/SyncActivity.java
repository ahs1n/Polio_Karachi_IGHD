...
import static edu.aku.dmu.polio_karachi_ighd.core.MainApp.sdDir;
import static edu.aku.dmu.polio_karachi_ighd.core.MainApp.uploadData;
...
import edu.aku.dmu.polio_karachi_ighd.adapters.SyncListAdapter;
...
import edu.aku.dmu.polio_karachi_ighd.contracts.TableContracts.ClusterTable;
import edu.aku.dmu.polio_karachi_ighd.contracts.TableContracts.EntryLogTable;
import edu.aku.dmu.polio_karachi_ighd.contracts.TableContracts.FormsTable;
import edu.aku.dmu.polio_karachi_ighd.contracts.TableContracts.RandomHHTable;
...
import edu.aku.dmu.polio_karachi_ighd.databinding.ActivitySyncBinding;
import edu.aku.dmu.polio_karachi_ighd.models.SyncModel;
import edu.aku.dmu.polio_karachi_ighd.workers.DataDownWorkerALL;
import edu.aku.dmu.polio_karachi_ighd.workers.DataUpWorkerALL;
import edu.aku.dmu.polio_karachi_ighd.workers.PhotoUploadWorker2;
