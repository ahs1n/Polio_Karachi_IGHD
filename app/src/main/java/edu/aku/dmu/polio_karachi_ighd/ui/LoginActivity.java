...
import static edu.aku.dmu.polio_karachi_ighd.core.CipherSecure.decryptGCM;
import static edu.aku.dmu.polio_karachi_ighd.core.CipherSecure.encryptGCM;
import static edu.aku.dmu.polio_karachi_ighd.core.CipherSecure.hashSHA256;
...
import static edu.aku.dmu.polio_karachi_ighd.database.DatabaseHelper.DATABASE_COPY;
...
//        throw new RuntimeException("Test Crash");
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.dmu.polio_karachi_ighd.ui.SyncActivity.class).putExtra("login", true));
        } else {
